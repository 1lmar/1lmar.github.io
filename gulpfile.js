...
// /* TOP LEVEL FUNCTIONS     gulp.task = Define tasks     gulp.src = Point to
// files to use     gulp.dest = Points to the folder to output     gulp.watch =
// Watch files and folders for changes */ Optimise Images
...
function watch_files() {
    ...
    gulp
        .watch("src/assets/js/*.js", jsd)
        .on("change", browserSync.reload);
    gulp
        .watch("src/pages/*.html", nunjucks)
        .on("change", browserSync.reload);
    gulp
...
exports.default = series(nunjucks, css, jsd, imageMin, watch_files);
